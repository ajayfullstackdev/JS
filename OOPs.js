...
// You need to use the concept of polymorphism. You need to create a parent class 'shape' which returns the area. 
// Create different classes circle,rectangle, sqaure and triangle which extend the parent class shape and calculate the area.
